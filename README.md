...
- **dev** : branche d’intégration (protégée). Toutes les fonctionnalités passent par elle avant d’aller sur `main`.  

👉 Le code est déjà structuré en deux dossiers :  
- `/frontend/` : pour le code du front-end  
...
2. Développer
	•	Si c’est du front : va dans /frontend/.
