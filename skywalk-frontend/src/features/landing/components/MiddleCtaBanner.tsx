        ...
        <section className="w-full bg-black relative overflow-hidden py-24 sm:py-32">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-8 relative z-10 flex flex-col items-center text-center">
                ...
                <p className="text-xl sm:text-2xl text-[#86868b] max-w-3xl mb-12 font-medium">
                    Join early adopters who are already planning their successful expatriation with SkyWalk. Get access to personalized prep-lists and cost-of-living tools for free.
                </p>
