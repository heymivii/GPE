...
const PROJECT_STATUS_STYLES = {
  planning: 'bg-brand-ink/10 text-brand-ink ring-1 ring-brand/20',
      ...
      <div className="group bg-white rounded-xl shadow-sm border border-gray-200 transition-all duration-200 flex flex-col h-full">
          ...
          <div className="flex justify-between items-start mb-4">
            ...
            <div className="relative">
              <button 
                ...
                className="p-1 text-gray-500 hover:text-gray-600 rounded-md hover:bg-gray-50 transition-colors"
                aria-expanded={showMenu}
                aria-label={t('projectsPage.card.menu', { defaultValue: 'Options du projet' })}
              >
          ...
          <div className="space-y-3 flex-1">
            {project.mainObjective && (
              <div className="flex items-center gap-3 text-sm text-gray-600">
                <div className="w-8 h-8 rounded-full bg-brand-ink/10 flex items-center justify-center text-brand-ink shrink-0">
        ...
        <div className="px-5 py-4 border-t border-gray-100 bg-gray-50/50 rounded-b-xl">
          <Link
            ...
            className="flex items-center justify-between w-full text-sm font-medium text-brand-ink hover:text-brand-ink-hover transition-colors"
          >
