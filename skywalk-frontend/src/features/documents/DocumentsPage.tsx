          ...
          <div className="flex flex-col sm:flex-row sm:items-stretch gap-2">
            ...
            <div className="flex flex-col gap-1">
              ...
              <select
                ...
                className="px-2.5 py-2 border border-gray-300 rounded-lg text-sm bg-white focus:border-brand sm:w-44"
              >
                {DOC_TYPES.map((k) => (
            ...
            <div className="flex flex-col gap-1">
              ...
              <select
                ...
                className="px-2.5 py-2 border border-gray-300 rounded-lg text-sm bg-white focus:border-brand sm:w-48"
              >
                <option value="">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-3">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-9 pr-3 py-2 border border-gray-200 rounded-lg text-sm bg-white focus:border-brand"
            />
          </div>
          <select
            value={filterType}
            onChange={(e) => setFilterType(e.target.value)}
            className="px-3 py-2 border border-gray-200 rounded-lg text-sm bg-white focus:border-brand"
          >
            <option value="all">
              ...
              return (
                ...
                >
                  ...
                  <div className="mt-3 flex items-center gap-2 flex-wrap">
                    {label ? (
                      <span className="inline-flex items-center gap-1 text-[11px] font-medium text-brand-ink bg-brand-ink/10 px-2 py-0.5 rounded-full">
                  ...
                  <div className="mt-3 pt-3 border-t border-gray-50 flex items-center gap-1">
                    <button
                      ...
                      className="flex-1 flex items-center justify-center gap-1.5 text-xs font-medium text-gray-600 hover:text-brand-ink hover:bg-brand-ink/10 rounded-lg py-1.5 transition-colors"
                    >
            ...
            <div className="flex items-center justify-between px-5 py-3 border-b border-gray-100">
              ...
              <div className="flex items-center gap-1 flex-shrink-0">
                <button
                  ...
                  className="p-2 text-gray-500 hover:text-brand-ink hover:bg-brand-ink/10 rounded-lg transition-colors"
                  title={t('documents.download')}
                >
                  <Download className="w-4 h-4" />
                </button>
