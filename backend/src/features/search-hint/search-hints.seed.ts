...
export const SEARCH_HINTS_SEED: SearchHintSeed[] = [
  ...
  { countryCode: 'FR', category: 'visa',
    ...
    queryLang: 'fr', excludeTerms: ['expatriation des français', 'quitter la france'], pinnedUrl: null },
  { countryCode: 'FR', category: 'demarches',
    officialDomains: ['service-public.fr', 'administration-etrangers.interieur.gouv.fr'], // ANEF
    keywords: 'carte de séjour titre de séjour première demande',
    queryLang: 'fr', excludeTerms: ['français à l’étranger'], pinnedUrl: null },
  { countryCode: 'FR', category: 'demarches-admin',
    officialDomains: ['service-public.fr'],
    keywords: 'démarches administratives installation étranger',
    queryLang: 'fr', excludeTerms: ['statistiques'], pinnedUrl: null },
  { countryCode: 'FR', category: 'logement',
    officialDomains: ['service-public.fr', 'dossierfacile.logement.gouv.fr', 'anil.org'],
    keywords: 'location logement dossier garant droits locataire',
    queryLang: 'fr', excludeTerms: ['logement social', 'hlm'], pinnedUrl: null },
  { countryCode: 'FR', category: 'sante',
    officialDomains: ['ameli.fr', 'service-public.fr'],
    keywords: 'affiliation assurance maladie PUMa nouvel arrivant',
    queryLang: 'fr', excludeTerms: ['partir à l’étranger', 'expatriation', 'AME'], pinnedUrl: null },
  { countryCode: 'FR', category: 'emploi',
    officialDomains: ['service-public.fr', 'travail-emploi.gouv.fr', 'francetravail.fr'],
    keywords: 'autorisation de travail salarié étranger',
    queryLang: 'fr', excludeTerms: [], pinnedUrl: null },
  { countryCode: 'FR', category: 'banque',
    officialDomains: ['service-public.fr', 'banque-france.fr'],
    keywords: 'ouvrir compte bancaire justificatifs',
    queryLang: 'fr', excludeTerms: [], pinnedUrl: null },
  { countryCode: 'FR', category: 'transport',
    officialDomains: ['service-public.fr'],
    keywords: 'échange permis de conduire étranger non européen',
    queryLang: 'fr', excludeTerms: ['contrôle technique'], pinnedUrl: null },
  { countryCode: 'FR', category: 'education',
    officialDomains: ['campusfrance.org', 'service-public.fr', 'monmaster.gouv.fr', 'parcoursup.fr'],
    keywords: 'inscription université étudiant étranger',
    queryLang: 'fr', excludeTerms: [], pinnedUrl: null },
  { countryCode: 'FR', category: 'culture',
    officialDomains: ['service-public.fr'], // ⚑ faible — catégorie molle
    keywords: 'vie associative apprendre le français',
    queryLang: 'fr', excludeTerms: [], pinnedUrl: null },
  { countryCode: 'FR', category: 'business',
    officialDomains: ['entreprendre.service-public.fr', 'autoentrepreneur.urssaf.fr', 'formalites.entreprises.gouv.fr'],
    keywords: 'créer entreprise auto-entrepreneur immatriculation',
    queryLang: 'fr', excludeTerms: [], pinnedUrl: null },

  // ───────────────────────── ÉTATS-UNIS (en) ─────────────────────────
  { countryCode: 'US', category: 'visa',
    officialDomains: ['travel.state.gov'], // ✓
    keywords: 'US visa types nonimmigrant apply',
    queryLang: 'en', excludeTerms: [], pinnedUrl: null },
  { countryCode: 'US', category: 'demarches',
    officialDomains: ['uscis.gov'], // ✓
    keywords: 'green card permanent residence adjust status',
    queryLang: 'en', excludeTerms: [], pinnedUrl: null },
  { countryCode: 'US', category: 'demarches-admin',
    officialDomains: ['ssa.gov', 'usa.gov'], // ✓ SSN
    keywords: 'social security number SSN apply noncitizen',
    queryLang: 'en', excludeTerms: [], pinnedUrl: null },
  { countryCode: 'US', category: 'logement',
    ...
    queryLang: 'en', excludeTerms: ['section 8', 'low income', 'public housing'], pinnedUrl: null },
  { countryCode: 'US', category: 'sante',
    officialDomains: ['healthcare.gov', 'usa.gov'], // ✓ ACA marketplace
    keywords: 'health insurance marketplace enroll',
    queryLang: 'en', excludeTerms: ['medicare', 'over 65'], pinnedUrl: null },
  { countryCode: 'US', category: 'emploi',
    officialDomains: ['uscis.gov', 'usa.gov'], // ✓ EAD
    keywords: 'employment authorization EAD work permit',
    queryLang: 'en', excludeTerms: ['department of transportation'], pinnedUrl: null },
  { countryCode: 'US', category: 'banque',
    officialDomains: ['fdic.gov', 'consumerfinance.gov'], // ✓
    keywords: 'open a bank account documents',
    queryLang: 'en', excludeTerms: [], pinnedUrl: null },
  { countryCode: 'US', category: 'transport',
  ...
  { countryCode: 'CH', category: 'demarches-admin',
    ...
    queryLang: 'fr', excludeTerms: [], pinnedUrl: null },
  { countryCode: 'CH', category: 'logement',
    officialDomains: ['ch.ch'],
    keywords: 'louer logement bail nouvel arrivant',
    queryLang: 'fr', excludeTerms: ['statistiques', 'loyer moyen'], pinnedUrl: null },
  { countryCode: 'CH', category: 'sante',
