...
describe('ForumTopicController', () => {
  ...
  describe('create()', () => {
    it('should delegate to service.create', async () => {
      const dto = { title: 'T', content: 'C', category: 'question', id: 1 };
  ...
  describe('update()', () => {
    it('should delegate to service.update', async () => {
      ...
      service.update.mockResolvedValue({ id: 1, title: 'Updated' });
  ...
  describe('lockTopic()', () => {
    it('should toggle lock', async () => {
      service.lockTopic.mockResolvedValue({ id: 1, isLocked: true });
  ...
  describe('pinTopic()', () => {
    it('should toggle pin', async () => {
      service.pinTopic.mockResolvedValue({ id: 1, isPinned: true });
