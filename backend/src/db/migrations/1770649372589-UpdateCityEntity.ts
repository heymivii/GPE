...
export class UpdateCityEntity1770649372589 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "city" ADD "slug" character varying(150)`,
    );
    await queryRunner.query(
      `ALTER TABLE "city" ADD CONSTRAINT "UQ_city_slug" UNIQUE ("slug")`,
    );
    await queryRunner.query(
      `ALTER TABLE "city" ADD "timezone" character varying(100)`,
    );
    await queryRunner.query(
      `ALTER TABLE "city" ADD "is_capital" boolean NOT NULL DEFAULT false`,
    );
    await queryRunner.query(
      `ALTER TABLE "city" ADD "priority" integer NOT NULL DEFAULT 0`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "city" DROP CONSTRAINT "UQ_city_slug"`,
    );
