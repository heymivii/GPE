...
export class CompleteSchemaRebuild1762802000000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TABLE IF EXISTS "administrative_process" CASCADE`);
        ...
        await queryRunner.query(`DROP TABLE IF EXISTS "expatriation_project" CASCADE`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_country_name" ON "country" ("country_name")`);
        await queryRunner.query(`CREATE INDEX "IDX_country_iso" ON "country" ("iso_code")`);
        await queryRunner.query(`CREATE INDEX "IDX_country_continent" ON "country" ("id_continent")`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_city_name" ON "city" ("city_name")`);
        await queryRunner.query(`CREATE INDEX "IDX_city_country" ON "city" ("id_country")`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_app_user_email" ON "app_user" ("email")`);
        await queryRunner.query(`CREATE INDEX "IDX_app_user_role" ON "app_user" ("user_role")`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_project_user" ON "expatriation_project" ("id_user")`);
        await queryRunner.query(`CREATE INDEX "IDX_project_status" ON "expatriation_project" ("project_status")`);
        await queryRunner.query(`CREATE INDEX "IDX_project_destination_country" ON "expatriation_project" ("id_destination_country")`);
        await queryRunner.query(`CREATE INDEX "IDX_project_destination_city" ON "expatriation_project" ("id_destination_city")`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_guide_country" ON "guide" ("id_country")`);
        await queryRunner.query(`CREATE INDEX "IDX_guide_type" ON "guide" ("guide_type")`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_checklist_country" ON "checklist" ("id_country")`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_resource_country" ON "resource" ("id_country")`);
        await queryRunner.query(`CREATE INDEX "IDX_resource_type" ON "resource" ("resource_type")`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_process_country" ON "administrative_process" ("id_country")`);
        await queryRunner.query(`CREATE INDEX "IDX_process_type" ON "administrative_process" ("process_type")`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_tracking_user" ON "process_tracking" ("id_user")`);
        await queryRunner.query(`CREATE INDEX "IDX_tracking_project" ON "process_tracking" ("id_project")`);
        await queryRunner.query(`CREATE INDEX "IDX_tracking_status" ON "process_tracking" ("status")`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_offer_city" ON "job_offer" ("id_city")`);
        await queryRunner.query(`CREATE INDEX "IDX_offer_sector" ON "job_offer" ("id_sector")`);
        await queryRunner.query(`CREATE INDEX "IDX_offer_date" ON "job_offer" ("publication_date")`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_experience_user" ON "experience" ("id_user")`);
        await queryRunner.query(`CREATE INDEX "IDX_experience_city" ON "experience" ("id_city")`);
        await queryRunner.query(`CREATE INDEX "IDX_experience_date" ON "experience" ("created_at")`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_comparison_user" ON "city_comparison" ("id_user")`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_topic_user" ON "forum_topic" ("id_user")`);
        await queryRunner.query(`CREATE INDEX "IDX_topic_country" ON "forum_topic" ("id_country")`);
        await queryRunner.query(`CREATE INDEX "IDX_topic_category" ON "forum_topic" ("category")`);
        await queryRunner.query(`CREATE INDEX "IDX_topic_created" ON "forum_topic" ("created_at")`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_message_topic" ON "forum_message" ("id_topic")`);
        await queryRunner.query(`CREATE INDEX "IDX_message_user" ON "forum_message" ("id_user")`);
        await queryRunner.query(`CREATE INDEX "IDX_message_created" ON "forum_message" ("created_at")`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_notification_user" ON "notification" ("id_user")`);
        await queryRunner.query(`CREATE INDEX "IDX_notification_read" ON "notification" ("is_read")`);
        await queryRunner.query(`CREATE INDEX "IDX_notification_created" ON "notification" ("created_at")`);
